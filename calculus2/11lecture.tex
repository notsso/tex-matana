...
\begin{lemma}\label{11_le1}
	При предпологаемых выше условиях для $f$ и $f(x)\ge0\ \fa x\in[a,b)$ несобственных интеграл $\ds\int_a^bf(x)dx$ сходится тогда и только тогда, когда $\ds\int_a^{\t b}f(x)dx$ ограничена.
\end{lemma}
\begin{proof}
...
\end{proof}
\begin{corollary}\nf{(Признак Абеля сходимости несобственных интегралов)}\\
	Пусть $f,g\in\mc R[a,\t b]\ \fa\t b\in[a,b)$. Если имеют место следующие утверждения:
	\begin{enumerate}
