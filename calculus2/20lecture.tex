...
\begin{proof}
	...
	\begin{multline*}
		...
		\subset(A\sm P_\eps)\cup(B\sm Q_\eps)\cup(P_\eps\sm A)\cup(Q_\eps\sm B)=(A\tr P_\eps)\cup(B\tr Q_\eps)\Ra\\
		\Ra\m((A\cup B)\tr(P_\eps\cup Q_\eps))\le\m(A\tr P_\eps)+\m(B\tr Q_\eps)<2\eps
	\end{multline*}
