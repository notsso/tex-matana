\begin{theorem}\nf{(Интегрируемость сложной функции)}\\
...
\begin{proof}
	...
	Ещё 
	\[U(P,h)-L(P,h)=\sum_{i=1}^n(M_i(h)-m_i(h))\tr x_i=\l(\sum_{i\in A}+\sum_{i\in B}\r)(M_i(h)-m_i(h))\tr x_i\]
...
\begin{corollary}
	...
	\begin{enumerate}
		\item $f_1,f_2\in\mc R[a,b]\Ra f_1\cdot f_2\in\mc R[a,b]$
...
\begin{definition}
	...
	\begin{multline*}
		A=\lim_{\tr(P)\ra0}S(P,f,\{t_i\})\lra\\
		\lra(\fa\eps>0)(\ex\delta>0)(\fa P,\ \tr(P)<\delta)(\fa\{t_i\},\ t_i\in[x_{i-1},x_i])\ |A-S(P,f,\{t_i\})|<\eps
	\end{multline*}
\end{definition}
\begin{lemma}
...
\end{proof}
\begin{theorem}\nf{(Интеграл как предел интегральных сумм)}\label{8_th1}\\
...
\begin{proof}
	...
	\[(\fa\eps>0)(\ex\delta_2)(\fa P,\ \tr(P)<\delta_2)\ L(P,f)>\int_a^bf(x)dx-\frac\eps2\]
