...
\begin{theorem}\nf{(Формула Тейлора с остаточным членом в форме Лагранжа)}\label{6_th1}\\
...
\begin{lemma}\label{6_le2}
	Если $g(\vx)$ удовлетворяет условиям \nf{(\ref{6_le1})} и $g$ обращается в $0$ в точке $\vx_0$ вместе со всеми производными до порядка $m$ включительно, то:
...
\begin{proof}
	...
	Получили требуемое.
\end{proof}
\begin{theorem}\nf{(Формула Тейлора с остаточным членом в форме Пеано)}
