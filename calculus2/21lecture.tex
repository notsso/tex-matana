...
\begin{definition}
	...
	Если $\ds\us{m\ra\i}{\v\lim}A_m=\us{m\ra\i}{\uv\lim}A_m=l$, то:
...
\begin{lemma}\label{21_l3}
	Если $A_1,A_2,\dots$ - измеримые по Лебегу подмножества $K_I$, то $\ds\us{m\ra\i}{\v\lim}A_m$ - измеримо по Лебегу, при этом: \[\mu(\us{m\ra\i}{\v\lim}A_m)\ge\us{m\ra\i}{\v\lim}\mu(A_m)\]
\end{lemma}
\begin{proof}
...
\begin{lemma}\label{21_l4}
	Если $A_1,A_2,\dots$ - измеримы по Лебегу подмножества $K_I$, то $\us{m\ra\i}{\uv\lim}A_m$ измеримо по Лебегу, при этом: \[\mu(\lim_{m\ra\i}A_m)\le\us{m\ra\i}{\uv\lim}\mu(A_m)\]
\end{lemma}
\begin{proof}
...
\begin{note}
	...
	\[K_I+(m_1,\dots,m_n)=\prod_{i=1}^n\l[\frac12+m_i,\ \frac12+m_i\r]\]
\end{note}
\begin{definition}
	Ограниченное множество $A\subset R^n$ называется \textit{измеримым по Жордану}, если $(\fa\v m\in\Z^n)\ A\cap(K_I+\v m)$ измеримо по Жордану, причём:
