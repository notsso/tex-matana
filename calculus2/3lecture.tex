...
\begin{proof}
	...
	\[G_1:=\{\v x\in G:\v x\text{ нельзя соединить с }\v x_1\text{ кривой в }G\},\ G_2=G\setminus G_1\]
	Докажем открытость $G_1$ и $G_2$ в $G$.\\
	Пусть $\v x_0\in G_2\subset G\Ra(\exists\eps>0)\ U_\eps(\v x_0)\subset G$\\
...
\begin{proof}
	...
	\end{multline*}
	Применим т. Лагранжа много раз: $\ex\xi_i\in\ [x_{i,0},x_{i,0}+\tr x_i],\ i=1,\dots,n$ (если $\tr x$ отрицателен, то $\xi_i\in[x_{i,0}+\tr x_i,x_{i,0}]$).
	\begin{multline*}
	...
	\begin{equation*}
		\begin{split}
			...
			&=\frac{\vd f}{\vd x_1}(\v x_0)\tr x_1+\dots+\frac{\vd f}{\vd x_n}(\v x_0)\tr x_n+\\
			&+\l(\frac{\vd f}{\vd x_1}(\xi_1,x_{2,0}+\tr x_2,\dots,x_{n,0}+\tr x_n)-\frac{\vd f}{\vd x_1}(\v x_0)\r)\tr x_1+\dots+\\
			&+\l(\frac{\vd f}{\vd x_n}(x_{1,0},\dots,x_{n-1},\xi_n)-\frac{\vd f}{\vd x_j}(\v x_0)\r)\tr x_n
		\end{split}
	\end{equation*}
