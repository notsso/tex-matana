\begin{note}
	...
	\[f\pm g,\ f\cdot g,\ \frac{f}{g},\ d(f\pm g)=df\pm dg,\ d(fg)=f\cdot dg+g\cdot df,\ d\l(\frac fg\r)=\frac{g\cdot df-f\cdot dg}{g^2}\]
\end{note}
\begin{theorem}
...
\end{proof}
\begin{corollary}\nf{(Инвариантность формы первого дифференциала)}
