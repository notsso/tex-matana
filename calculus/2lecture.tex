	...
	\begin{proof}
		...
		\begin{multline*}
			\lim_{k\ra\infty}=\v x_0\Ra\lim_{k\ra\infty}g_j(\v x_k)=g_j(\v x_0)=y_0,\ j=1,\dots,n\Ra\\
	...
	\begin{proof}
		...
		Получили, что пределы последовательностей равны, в то время как они должны быть $\ge\eps$. Противоречие. Значит равномерная непрерывность следует из непрерывности. 
	\end{proof}
	...
	\begin{proof}
		От противного. \\
		Пусть $A$ не связно $\Ra \exists G_1,G_2$ - открытые в $A,\\ G_1\neq\varnothing,\ G_2\neq\varnothing,\ G_1\cap G_2=\varnothing,\ G_1\cup G_2=A$
		\newpage
		$\hspace{-0.5cm}\text{Пусть }\v x\in G_1,\ \v y\in G_2.\ A\text{ - линейно связно }\Ra\exists\gamma\subset A,\ \gamma(a)=\v x,\ \gamma(b)=\v y$\\
