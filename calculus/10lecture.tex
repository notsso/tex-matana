\begin{anote}
	Для читателя, который не знает что такое подстановки Абеля, приведём статью с википедии:\\
	...
	\end{equation*}
\end{anote}
\begin{lemma}[Формула Бонне]\label{10_le1}
...
\begin{proof}
	...
	Получили требуемое.
\end{proof}
\begin{note}[О вычислении интеграла Римана - Стильтьеса]
...
\end{proof}
\begin{note}[О вычислении интеграла Римана - Стильтьеса]
	Если $f$ ограничена на $[a,b]$ и непрерывна в точках $r_1,\dots,r_N\in[a,b]$m а функция $g$ постоянна на интервалах $\subset[a,b]$, не содержащих точек $r_1,\dots,r_N$, и непрерывна в $a,b$ (если $a,b$ не совпадают с одной из $r_1,\dots,r_N$), то $f$ интегрируема по Риману - Стильтьесу по $g$ на $[a,b]$, причём:
