\begin{definition}
	Функциональный ряд $\ss f_n(x)$ \textit{сходится равномерно} на множестве $E$, если на $E$ равномерно сходится последовательность его частичных сумм $\ds==\{\sum_{k=1}^nf_k(x)\}_{n=1}^\i$.
\end{definition}
