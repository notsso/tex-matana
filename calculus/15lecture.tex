\begin{definition}
	Функциональный ряд $\ss f_n(x)$ сходится равномерно на множестве $E$, если на $E$ равномерно сходится последовательность его частичных сумм $\{\sum_{k=1}^nf_k(x)\}_{n=1}^\i$.
\end{definition}
...
\end{proof}
\begin{definition}
	Назовём функциональную последовательность $\sq[f_n(x)]$ равномерно ограниченной на $E$, если:
...
\begin{theorem}\nf{(Признак Дини равномерной сходимости функциональной последовательности)}\label{15_th6}\\
	Допишу чуть позже. Пусть $E$ - компактное множество. Если $\fa x\in E$
\end{theorem}